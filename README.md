...
|2.1|Intégrer dans σ un processus de transformation des documents XML en vue de leur usage dans Collatex. L'input est produit sur la base d'un template. Un système de templating **simple** est donc à concevoir. On concevra un système simple en s'appuyant sur des classes de données Pydantic et sur un système qui permettra de sélectionner la bonne classe sur la base d'un paramètre.|module|non|à distinguer du système de template qui se trouve éventuellement au niveau du module 2.2.|
